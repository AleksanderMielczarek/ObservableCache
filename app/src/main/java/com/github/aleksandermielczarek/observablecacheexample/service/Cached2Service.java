...
public interface Cached2Service {
    ...
    CacheableFlowable<String> flowableError();

    FlowableFromCache<String> cachedFlowableError();
    ...
    CacheableMaybe<String> maybeError();

    MaybeFromCache<String> cachedMaybeError();
